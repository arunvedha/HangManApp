package com.example.android.hangmanapp;
...
import com.example.android.hangmanapp.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    int randoms,counter=0,flag=0,sum=0,score,highScore=0;
    int[] a = new int[50];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (guesses.length()==0)Toast.makeText(MainActivity.this,
                    ...
                    if (newName.indexOf('_')<0 ){
                        ...
                        if (score>highScore){
                            highScore=score;
                            SharedPreferences myscore = getSharedPreferences("My awesome score ", Context.MODE_PRIVATE);
